...
@Component({
  ...
  templateUrl: './perhitungan-nilai-terbobot.component.html',
  styleUrls: ['./perhitungan-nilai-terbobot.component.scss']
})
export class PerhitunganNilaiTerbobotComponent implements OnInit, OnDestroy {

  displayedColumns: string[] = ['index', 'nama', 'C01', 'C02', 'C03', 'C04', 'C05', 'C06'];
  displayedColumnsOptimasi: string[] = ['index', 'nama', 'max', 'min', 'yi'];
  matriksKeputusan = [];
  matriksOptimasi = [];
  matriksO = [];
  matriksRank = [];
